...
import { STATIONS, PASSENGERS } from "@/features/check-in/data/stations";
      ...
      <div className="flex-1 flex flex-col">
        {appState === "select-station" && (
          <div className="flex-1 p-4 bg-white">
            <StationList stations={STATIONS} onSelect={handleSelectStation} />
          </div>
        )}

        {appState === "select-passenger" && (
          <div className="flex-1 p-4 bg-white">
            <PassengerList passengers={PASSENGERS} onSelect={handleSelectPassenger} />
          </div>
        )}
